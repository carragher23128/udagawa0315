...
lw_1.lw.watcher.bib.onCreate(filePath => parseBibFile(filePath));
lw_1.lw.watcher.bib.onChange(filePath => parseBibFile(filePath));
lw_1.lw.watcher.bib.onDelete(filePath => removeEntriesInFile(filePath));
/**
